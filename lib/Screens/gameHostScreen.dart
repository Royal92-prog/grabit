...
<<<<<<< Updated upstream
      ...
      //SvgPicture.asset('assets/HostGame/mainHeader.svg',width: 0.2 * size.width, height: 0.07 * size.height)),
            ...
            Positioned(
              ...
              top: size.height * 0.425,
              child: GestureDetector(child: Image.asset('assets/HostGame/+ btn.png',
=======
      extendBody: true,
...
<<<<<<< Updated upstream
            ...
            Positioned(
              ...
              child: GestureDetector(child:
                Image.asset('assets/HostGame/clean+-.png',
                  height: 0.08 * size.height,
                  width: 0.1 * size.width),
              onTap: null, //() => setState(() {
            ...
            Positioned(
              left: size.width * 0.52 ,
              top: size.height * 0.55,
              child: gameTimeLimit == 0 ?
                Text('NO', style: GoogleFonts.galindo(
                  fontSize: 10,
                  color: Colors.black,
                  fontWeight:FontWeight.w300,
                  decoration: TextDecoration.none)) :
                Text('YES', style: GoogleFonts.galindo(
                  fontSize: 10,
                  color: Colors.black,
                  fontWeight:FontWeight.w300,
                  decoration: TextDecoration.none))),
            Positioned(
              ...
              child: GestureDetector(child: Image.asset('assets/HostGame/back.png',
