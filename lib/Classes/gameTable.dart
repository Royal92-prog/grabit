...
=======
            ...
            playersNumber > 3 ? Positioned(
              ...
              child: Player(
                ...
                deviceIndex: playerIndex,
                collectionName: collectionName)) : SizedBox(),
            //totem
            Positioned(
              left : size.width * 0.4,
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              onTap: () async{
                ...
                await _firestore.collection(collectionName).doc('game${gameNum}').set(
                ...
                await _firestore.collection(collectionName).doc('game${gameNum}MSGS').
...
=======
      ...
      await FirebaseFirestore.instance.collection(collectionName).doc('players${gameNum}').delete();
>>>>>>> Stashed changes
    }
